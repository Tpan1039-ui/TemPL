...
### What is TemPL?
TemPL, a novel protein language model, has been developed for predicting the Optimal Growth Temperature (OGT) and enabling zero-shot prediction of protein thermostability and activity. This novel approach leverages temperature-guided language modeling.
<div align="center">
    <a href="https://"><img width="1000px" height="auto" src="https://github.com/ai4protein/TemPL/blob/main/model.jpg"></a>
</div>

### The results of TemPL.
...
##### TM datasets
|           | ESM-1v | ROSSETA | MSA-Transformer | TemPL(- OGT task) |  TemPL |     Tranception      | TemPL (Fine-tuned) |
|:---------:|:------:|:-------:|:---------------:|:-----------------:|:------:|:--------------------:|:------------------:|
...
##### Activity datasets
|                      | ESM-1v | MSA-transformer | TemPL (- OGT task) | TemPL | Tranception | TemPL (fine-tuned) |
|:--------------------:|:------:|:---------------:|:------------------:|:-----:|:-----------:|:------------------:|
...
### Tips
It is important to emphasize that TemPL builds upon the [esm2-650M](https://github.com/facebookresearch/esm) framework. Specifically, we utilize the checkpoint provided by the framework to initialize the model parameters.
